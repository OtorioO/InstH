...
/* package nscotty-0.1.0.0 */
#define VERSION_nscotty "0.1.0.0"
#define MIN_VERSION_nscotty(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package fixed-vector-0.8.1.0 */
#define VERSION_fixed_vector "0.8.1.0"
...
/* package yarr-1.4.0.2 */
#define VERSION_yarr "1.4.0.2"
#define MIN_VERSION_yarr(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  4 || \
...
#define CURRENT_COMPONENT_ID "nscotty-0.1.0.0-JMcufeeq8bB8bh9M2lsf5p"

#define CURRENT_PACKAGE_KEY "nscotty-0.1.0.0-JMcufeeq8bB8bh9M2lsf5p"
